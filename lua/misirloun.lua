...
local function set_highlights()
    ...
    local default_highlights = {
        ...
        ["@keyword.import"] = { fg = palette.c6 },
        ["@keyword.storage"] = { fg = palette.c7 },
        ["@keyword.repeat"] = { fg = palette.c6 },
        ["@keyword.return"] = { fg = palette.c6 },
        ["@keyword.debug"] = { fg = palette.c7 },
        ["@keyword.exception"] = { fg = palette.c6 },

        ["@keyword.conditional"] = { fg = palette.c6 },
        ...
        NavicIconsProperty = { fg = palette.c7 },
