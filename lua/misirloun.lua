...
local function set_highlights()
    ...
    local default_highlights = {
        ...
        Visual = { fg = palette.bg, bg = palette.text },
        ...
        ["@constant.builtin"] = { fg = palette.lavender, bold = styles.bold },
        ...
        blinkcmpdefault = { fg = palette.text },
        blinkcmpkindtext = { fg = palette.text },
        BlinkCmpKindMethod = { fg = palette.text },
        BlinkCmpKindFunction = { fg = palette.text },
        BlinkCmpKindConstructor = { fg = palette.text },
        BlinkCmpKindField = { fg = palette.text },
        BlinkCmpKindVariable = { fg = palette.text },
        BlinkCmpKindClass = { fg = palette.text },
        BlinkCmpKindInterface = { fg = palette.text },
        BlinkCmpKindModule = { fg = palette.text },
        BlinkCmpKindProperty = { fg = palette.text },
        BlinkCmpKindUnit = { fg = palette.text },
        BlinkCmpKindValue = { fg = palette.text },
        BlinkCmpKindKeyword = { fg = palette.text },
        BlinkCmpKindSnippet = { fg = palette.text },
        BlinkCmpKindColor = { fg = palette.text },
        BlinkCmpKindFile = { fg = palette.text },
        BlinkCmpKindReference = { fg = palette.text },
        BlinkCmpKindFolder = { fg = palette.text },
        BlinkCmpKindEnum = { fg = palette.text },
        BlinkCmpKindEnumMember = { fg = palette.text },
        BlinkCmpKindConstant = { fg = palette.text },
        BlinkCmpKindStruct = { fg = palette.text },
        BlinkCmpKindEvent = { fg = palette.text },
        BlinkCmpKindOperator = { fg = palette.text },
        BlinkCmpKindTypeParameter = { fg = palette.text },
        BlinkCmpKindCodeium = { fg = palette.text },
        BlinkCmpKindCopilot = { fg = palette.text },
        BlinkCmpKindSupermaven = { fg = palette.text },
        BlinkCmpKindTabNine = { fg = palette.text },
